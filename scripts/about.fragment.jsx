...
<img className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" data-alt="Monochrome close-up portrait of a thoughtful contemporary male creator looking slightly off-camera in natural morning window light, high contrast art gallery style with deep crisp shadows and pure highlights, 35mm documentary aesthetic" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=900&q=80" />
...
<img className="w-full h-full object-cover" data-alt="Black and white street photography shot of a bustling morning wet market, soft cinematic natural mist, elderly vendor arranging crisp greens, documentary realism, clean framing" src="https://images.unsplash.com/photo-1556910103-1c02745aae4d?auto=format&fit=crop&w=1200&q=80" />
</div>
<div className="aspect-video w-full rounded-lg overflow-hidden bg-surface-container shadow-sm">
<img className="w-full h-full object-cover" data-alt="Close up architectural detail of vintage residential windows with green foliage plants hanging over iron grilles, late afternoon warm shadow contrast, editorial minimalism" src="https://images.unsplash.com/photo-1464146072230-91cabc968266?auto=format&fit=crop&w=1200&q=80" />
</div>
</div>
</div>
</article>
